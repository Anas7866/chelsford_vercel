    ...
    <div className='col-md-12 background_over_flow'>
        <div className='col-md-12 background_color_image '>
            <div className='row'>
                ...
                <img src='../contactimages/medical.png' className='img-fluid width_profiles' />
                </div>
            </div>
        </div>
        <div className='col-md-12 margin_negative_top'>
            <div className='col-md-12 text-center'>
                <h1 className='color_pop'><b>Popular Medical Treatment</b></h1>
            ...
            <div className='container px-md-5  mb-5'>
                <div className='row'>
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/Medical-Aesthetics-Diplomas"
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/foundation-botox-and-dermal-fillers"
                                className="hover__linka" > 
                            <div className='col-md-12'>
                                <img src='../contactimages/chelsfordscards/2.png' className='img-fluid img_size_fix'/>
                            </div>
                            <div className='col-md-12 py-3 px-3'>
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/advanced-botox-and-dermal-fillers"
                                className="hover__linka" >
                            <div className='col-md-12'>
                                <img src='../contactimages/chelsfordscards/22.png' className='img-fluid img_size_fix' />
                            </div>
                            <div className='col-md-12 py-3 px-3'>
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/prp-advanced-treatments"
                                className="hover__linka" >
                            <div className='col-md-12'>
                                <img src='../contactimages/chelsfordscards/20.png' className='img-fluid img_size_fix' />
                            </div>
                            <div className='col-md-12 py-3 px-3'>
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/laser-skin-resurfacing-training"
                                className="hover__linka" >
                            <div className='col-md-12'>
                                <img src='../contactimages/chelsfordscards/18.png' className='img-fluid img_size_fix' />
                            </div>
                            <div className='col-md-12 py-3 px-3'>
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/intimate-laser-rejuvenation"
                                className="hover__linka" > 
                            <div className='col-md-12'>
                                <img src='../contactimages/chelsfordscards/19.png' className='img-fluid img_size_fix' />
                            </div>
                            <div className='col-md-12 py-3 px-3'>
