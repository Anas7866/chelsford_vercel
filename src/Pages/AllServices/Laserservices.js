        ...
        <div className='col-md-12 background_color_image '>
            <div className='row '>
                <div className='col-md-6 padding_handle '>
                    ...
                    <h5 className=' line_height1 display_mobile'>Chelsford is the premier aesthetic training institute where the finest aesthetic trainers in the UK will instill their knowledge to develop your professional skills. All our Laser courses satisfy Insurance, Council and JCCP regulations.</h5>
                ...
                <div className='col-md-6 text-center m-auto img_spacing_mob'>
                    ...
                    <img src='../contactimages/laser.png' className='img-fluid width_profiles' />
                </div>
            </div>
        </div>
        <div className='col-md-12 margin_negative_top'>
            <div className='col-md-12 text-center'>
                <h1 className='color_pop'><b>Popular Laser Courses</b></h1>
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            ...
                            <div className='col-md-12'>
                                <img src='../contactimages/chelsfordscards/23.png' className='img-fluid img_size_fix' />
                            </div>
                            <div className='col-md-12 py-3 px-3'>
                                <h3><b>VTCT NVQ Level 4 Laser & IPL Traning</b></h3>
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/level-4-laser-and-blemish-removal"
                                className="hover__linka" > 
                            <div className='col-md-12'>
                                <img src='../contactimages/l7.png' className='img-fluid' />
                            </div>
                            <div className='col-md-12 py-3 px-3'>
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/laser-practitioner-diploma-vtct"
                                className="hover__linka" > 
                            <div className='col-md-12'>
                                <img src='../contactimages/l2.png' className='img-fluid' />
                            </div>
                            <div className='col-md-12 py-3 px-3'>
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/level-5-laser-tattoo-removal"
                                className="hover__linka" >
                            <div className='col-md-12'>
                                <img src='../contactimages/l6.png' className='img-fluid' />
                            </div>
                            <div className='col-md-12 py-3 px-3'>
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/advanced-laser-diploma"
                                className="hover__linka" > 
                            <div className='col-md-12'>
                                <img src='../contactimages/l5.png' className='img-fluid' />
                            </div>
                            <div className='col-md-12 py-3 px-3'>
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/fat-freeze-and-body-sculpting"
                                className="hover__linka" > 
                            <div className='col-md-12'>
                                <img src='../contactimages/l3.png' className='img-fluid' />
                            </div>
                            <div className='col-md-12 py-3 px-3'>
                    ...
                    <div className='col-md-4 pt-4 px-4'>
                        ...
                        <Link
                            to="/course/laser-core-of-knowledge"
                                className="hover__linka" >
                            <div className='col-md-12'>
                                <img src='../contactimages/l1.png' className='img-fluid' />
                            </div>
                            <div className='col-md-12 py-3 px-3'>
