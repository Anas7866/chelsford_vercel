    ...
    <div className='col-md-12 background_color_image '>
        <div className='row'>
            <div className='col-md-6 pt-2 padding_handle'>
                ...
                <h5 className=' line_height1 display_mobile'>
            ...
            <img src='../contactimages/beauty.png' className='img-fluid width_profiles' />
            </div>
        </div>
    </div>
    <div className='col-md-12 margin_negative_top'>
        <div className='col-md-12 text-center'>
            <h1 className='color_pop'><b>Popular Beauty Courses</b></h1>
                ...
                <div className='col-md-4 pt-4 px-4'>
                    ...
                    <Link
                        ...
                        <div className='col-md-12'>
                            <img src='../contactimages/chelsfordscards/16.png' className='img-fluid img_size_fix' />
                        </div>
                ...
                <div className='col-md-4 pt-4 px-4'>
                    ...
                    <Link
                        to="/course/vtct-level-3-nvq-beauty-therapy"
                            className="hover__linka" > 
                        <div className='col-md-12'>
                            <img src='../contactimages/chelsfordscards/5.png' className='img-fluid img_size_fix' />
                        </div>
                        <div className='col-md-12 py-3 px-3'>
                ...
                <div className='col-md-4 pt-4 px-4'>
                    ...
                    <Link
                        to="/course/fast-track-vtct-level-3-nvq-beauty-therapy"
                            className="hover__linka" >
                        <div className='col-md-12'>
                            <img src='../contactimages/chelsfordscards/21.png' className='img-fluid img_size_fix' />
                        </div>
                        <div className='col-md-12 py-3 px-3'>
                ...
                <div className='col-md-4 pt-4 px-4'>
                    ...
                    <Link
                        to="/course/vtct-level-2-and-3-nvq-beauty-therapy"
                            className="hover__linka" >
                        <div className='col-md-12'>
                            <img src='../contactimages/chelsfordscards/9.png' className='img-fluid img_size_fix' />
                        </div>
                        <div className='col-md-12 py-3 px-3'>
                ...
                <div className='col-md-4 pt-4 px-4'>
                    ...
                    <Link
                        to="/course/vtct-level-2-3-and-4-nvq-beauty-and-laser"
                            className="hover__linka" >
                        <div className='col-md-12'>
                            <img src='../contactimages/chelsfordscards/17.png' className='img-fluid img_size_fix' />
                        </div>
                        <div className='col-md-12 py-3 px-3'>
                ...
                <div className='col-md-4 pt-4 px-4'>
                    ...
                    <Link
                        to="/course/vtct-level-2-award-facial-and-skincare"
                            className="hover__linka" >
                        <div className='col-md-12'>
                            <img src='../contactimages/chelsfordscards/7.png' className='img-fluid img_size_fix' />
                        </div>
                        <div className='col-md-12 py-3 px-3'>
                ...
                <div className='col-md-4 pt-4 px-4'>
                    ...
                    <Link
                        to="/course/vtct-level-3-in-epilation"
                            className="hover__linka" > 
                        <div className='col-md-12'>
                            <img src='../contactimages/chelsfordscards/15.png' className='img-fluid img_size_fix' />
                        </div>
                        <div className='col-md-12 py-3 px-3'>
                ...
                <div className='col-md-4 pt-4 px-4'>
                    ...
                    <Link
                        to="/course/vtct-level-3-facial-electrotherapy"
                            className="hover__linka" >
                        <div className='col-md-12'>
                            <img src='../contactimages/chelsfordscards/13.png' className='img-fluid img_size_fix' />
                        </div>
                        <div className='col-md-12 py-3 px-3'>
                ...
                <div className='col-md-4 pt-4 px-4'>
                    ...
                    <Link
                        to="/course/vtct-level-4-skin-blemish-removal"
                            className="hover__linka" > 
                        <div className='col-md-12'>
                            <img src='../contactimages/chelsfordscards/8.png' className='img-fluid img_size_fix' />
                        </div>
                        <div className='col-md-12 py-3 px-3'>
                ...
                <div className='col-md-4 pt-4 px-4'>
                    ...
                    <Link
                        to="/course/cpd-advanced-plasma-fibroblast"
                            className="hover__linka" >
                        <div className='col-md-12'>
                            <img src='../contactimages/chelsfordscards/12.png' className='img-fluid img_size_fix' />
                        </div>
                        <div className='col-md-12 py-3 px-3'>
                ...
                <div className='col-md-4 pt-4 px-4'>
                    ...
                    <Link
                        to="/course/cpd-microneedling-diploma"
                            className="hover__linka" > 
                        <div className='col-md-12'>
                            <img src='../contactimages/chelsfordscards/14.png' className='img-fluid' />
                        </div>
                        <div className='col-md-12 py-3 px-3'>
