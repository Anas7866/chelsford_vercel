    ...
    <div className='col-md-12'>
        ...
        <div className='col-md-12 background_image_contact_us'>
            <div className='col-md-12'>
                ...
                We are looking forward to hearing from you. If you have any questions, comments or <br/> suggestions, send in your details, and our careers advisor will contact you immediately.
                </p>
            </div>
            ...
            <div className='row'>
                <div className='col-md-8'>
                    <div className='col-md-12 text-center'>
                        ...
                        <p className='paragraph_central pb-4'>50 Mark Ln, London EC3R 7QR</p>
                    </div>
                    <div className='col-md-12'>
